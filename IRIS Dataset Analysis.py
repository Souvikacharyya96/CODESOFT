...
Original file is located at
    https://colab.research.google.com/drive/1LsJU9rMFo95otHroux8uNmdsxOTL1dlb#scrollTo=zOIC6ue7Hbuo
...
_ = tree.plot_tree(classify, feature_names=F, class_names=T, filled=True)
plt.show()